...
{  
    ...
    {  
        try
        {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql:///qa","root","root"); //connecting to database 'qa'
    ...
    void adduserans() //function to connect to qa database and insert user's answers into ua table
    {
        ...
        {
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql:///qa","root","root");
            Statement stmt = con.createStatement();
            for(int i=0;i<=3;i++)
            {
